package com.example.tutorial.view.fragment;
...
import com.example.tutorial.adapter.MovieDiscoverAdapter;
import com.example.tutorial.model.movie.MovieDiscoverResultsItem;
import com.example.tutorial.view.viewmodel.MovieViewModel;
...
public class  MovieFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        movieViewModel.getMovieDisc().observe(this,getMovieDiscover);
